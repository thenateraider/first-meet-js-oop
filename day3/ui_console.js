...
import recruitAnimal from "./recruit-animal.js";
...
function askForCommand() {
  rl.question(
    "\n[l] Left | [r] Right | [i] Inspect | [d] Directory | [a] Recruit New Animal | [q] Quit\n> ",
    (answer) => {
...
function handleCommand(command) {
  switch (command) {
    case "l":
      visitorInfo.visitors.moveLeft();
      displayZoo();
      askForCommand();
      break;
    case "r":
      visitorInfo.visitors.moveRight(zoo.zooPath.length - 1);
      displayZoo();
      askForCommand();
      break;
    case "i":
    ...
    case "d":
      ...
      break;
    case "a":
      recruitAnimal.addAnimalInZoo(rl, zoo, displayZoo, askForCommand);
      break;
    default:
      console.log("Please Enter l, r, i, d, a or q");
      displayZoo();
      askForCommand();
      break;
  }
